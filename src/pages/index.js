...
const IndexPage = () => {
  return (
    <Layout title="Home" description="I am a Full Stack Developer who is interesting in broadening my development knowledge. On this website we explore the training courses that I have undertaken.">
      ...
      <p>If you are interested in what I have been upto, you can find out by visiting <Link to="/about">My Portfolio</Link>.</p>
      <p>I started to do some light training using <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer">YouTube</a> but then I moved over to paid for courses on <a href="https://www.udemy.com/" target="_blank" rel="noopener noreferrer">Udemy</a> after being sucked in via a pricing promotion.</p>
