...
const AboutPage = () => {
  return (
    <Layout title="About Me" description="I am a Full Stack Developer who is interesting in broadening my development knowledge. On this website we explore the training courses that I have undertaken.">
      <h1>About Me</h1>
      <p>I am a Full Stack Developer who is interesting in broadening my development knowledge. I have been a Developer for nearly 15 years. However, in all that time, I have not made a website for myself. Now I have some time.</p>
