...
const AboutPage = () => {
  return (
    <Layout title="About Me" description="I am a Full Stack Developer who is interesting in broadening my development knowledge. On this website we explore the training courses that I have undertaken.">
      <h1>About Me</h1>
      <p>Hi, I'm Andrew Lilley. I am a Full Stack Developer who is interesting in broadening my development knowledge. I have been a Developer for over 15 years. However, in all that time, I have not made a website for myself. Now I have some time.</p>
      ...
      <p>Since beginning this journey, I have moved on to doing React courses. I also now have a backlog of courses to tackle. I have courses lined up for GraphQL, Typescript, Node.js and Deno. My thoughts and links to the demo applications are all available on the <Link to="/training-courses/">training courses</Link> section.</p>
